import massacreDefaults from '../data/massacreDefaults.json';
import { IMassacreTrack } from '@/app/massacres/massacreTrack';
import {
  createContext,
  Dispatch,
  ReactNode,
      ...
      if (store && store.length > 0) {
        dispatch({
          ...
          trackers: store.map((x) => {
            const tracker: IMassacreTrack = { ...x, hazRezSystem: x.hazRezSystem.toUpperCase() };
            return tracker;
          }),
        });
      } else {
